...
class WeekView<T extends Object?> extends StatefulWidget {
  ...
  final Function(DateTime)? onClickCalendar;

  final Function(List<DateTime>)? onSelectingMultiple;
                      ...
                      itemBuilder: (_, index) {
                        ...
                        return ValueListenableBuilder(
                          ...
                          builder: (_, __, ___) => InternalWeekViewPage<T>(
                            ...
                            onClickCalendar: (pos) {
                              final date = dates[pos.col]
                                  .copyWith(hour: pos.row + _startHour);
                              widget.onClickCalendar?.call(date);
                            },
                            onSelectingMultiple: (events) {
                              final list = <DateTime>[];
                              for (final event in events) {
                                list.add(
                                  dates[event.col]
                                      .copyWith(hour: event.row + _startHour),
                                );
                              }
                              widget.onSelectingMultiple?.call(list);
                            },
                          ),
                        );
                      },
